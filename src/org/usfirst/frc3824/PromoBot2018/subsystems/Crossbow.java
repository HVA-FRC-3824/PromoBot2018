...
//        }
	...
	/*********************************************************************
	 * Uses PIDs with Talon SRX encoder feedback to set the position of the crossbow rotator to a specified position in encoder ticks
	 *********************************************************************/
	 ...
	 *********************************************************************/
	public void setRotatorMotorPercent(double percent)
	{	
		// Set setpoint
		rotator.set(percent);
	}
	...
	/*********************************************************************
	 * Controls crossbow rotator manually based off of driver input
	 *********************************************************************/
	public void manualRotatorControl()
	{
		// Calculate scaling factor to multiply the input by to get the angle to set the rotator to
		double angleScaleFactor = (Constants.CROSSBOW_ROTATOR_MAX_ANGLE - Constants.CROSSBOW_ROTATOR_MIN_ANGLE) / (1.0 - -1.0);
		
		// Angle to set rotator = scaling factor * input value
		double targetAngle =  angleScaleFactor * Robot.oi.joystick.getThrottle();
		
		setRotatorPositionAngle(targetAngle);
	}
